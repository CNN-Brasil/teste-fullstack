...
function redirect_canonical($requested_url = null, $do_redirect = true)
{
    ...
    if (
        is_admin() || is_search() || is_preview() || is_trackback() || is_favicon()
    ...
    if (is_404()) {
        ...
        if (get_query_var('sitemap')) {
            ...
            while (
                preg_match("#/$wp_rewrite->pagination_base/?[0-9]+?(/+)?$#", $redirect['path'])
