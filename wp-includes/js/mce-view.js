...
( function ( window, wp, shortcode, $ ) {
	...
	_.extend(
		wp.mce.View.prototype, /** @lends wp.mce.View.prototype */
		{
			...
			setIframes: function ( head, body, callback, rendered ) {
				...
				this.getNodes(
					function ( editor, node ) {
						...
						tinymce.each(
							dom.$( 'link[rel="stylesheet"]', editorHead ),
							function ( link ) {
