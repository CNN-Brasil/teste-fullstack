...
if ( PHP_VERSION_ID < 70000 ) {
	...
	require_once __DIR__ . '/autoload-php7.php';
}
...
if ( ! class_exists( 'SodiumException', false ) ) {
	require_once __DIR__ . '/src/SodiumException.php';
}
if ( PHP_VERSION_ID >= 50300 ) {
	// Namespaces didn't exist before 5.3.0, so don't even try to use this
	// unless PHP >= 5.3.0
	require_once __DIR__ . '/lib/namespaced.php';
	require_once __DIR__ . '/lib/sodium_compat.php';
} else {
	require_once __DIR__ . '/src/PHP52/SplFixedArray.php';
}
if ( PHP_VERSION_ID < 70200 || ! extension_loaded( 'sodium' ) ) {
	if ( PHP_VERSION_ID >= 50300 && ! defined( 'SODIUM_CRYPTO_SCALARMULT_BYTES' ) ) {
		require_once __DIR__ . '/lib/php72compat_const.php';
	}
	if ( PHP_VERSION_ID >= 70000 ) {
	...
	require_once __DIR__ . '/lib/php72compat.php';
} elseif ( ! function_exists( 'sodium_crypto_stream_xchacha20_xor' ) ) {
	// Older versions of {PHP, ext/sodium} will not define these
	require_once __DIR__ . '/lib/php72compat.php';
}
require_once __DIR__ . '/lib/stream-xchacha20.php';
require_once __DIR__ . '/lib/ristretto255.php';
