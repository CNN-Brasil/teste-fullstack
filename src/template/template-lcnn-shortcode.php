<?php wp_enqueue_style('lcnn-style', plugins_url('/css/style.css', __FILE__)); ?>
...
<?php foreach ($premiacoes as $i => $premiacao) : ?>
    <section class="grid grid-auto-rows-3">
        ...
        <div class="item premio-color-black">R$ <?= esc_html(LCNN_Utils::format_currency($premiacao['valorPremio'])) ?></div>
    </section>
