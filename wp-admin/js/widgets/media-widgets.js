...
wp.mediaWidgets = ( function ( $ ) {
	...
	component.MediaWidgetControl = Backbone.View.extend(
		/** @lends wp.mediaWidgets.MediaWidgetControl.prototype */        {
			...
			syncModelToInputs: function syncModelToInputs() {
				var control = this;
				control.syncContainer.find( '.media-widget-instance-property' ).each(
					function () {
			...
			mapMediaToModelProps: function mapMediaToModelProps( mediaFrameProps ) {
				...
				_.each(
					...
					function ( fieldSchema, modelProp ) {
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		 ...
		 */
		modelAttributes = {};
		syncContainer.find( '.media-widget-instance-property' ).each(
			function () {
				var input                                   = $( this );
	...
	component.handleWidgetUpdated = function handleWidgetUpdated( event, widgetContainer ) {
		...
		widgetContent.find( '.media-widget-instance-property' ).each(
			function () {
