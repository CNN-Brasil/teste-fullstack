...
(function ($) {
	$(
		function () {
			 ...
			 * @return {void}
			 */
			$( 'select[name="background-size"]' ).on(
				'change',
				function () {
			 ...
			 * @return {void}
			 */
			$( 'input[name="background-position"]' ).on(
				'change',
				function () {
			 ...
			 * @return {void}
			 */
			$( 'input[name="background-repeat"]' ).on(
				'change',
				function () {
			 ...
			 * @return {void}
			 */
			$( 'input[name="background-attachment"]' ).on(
				'change',
				function () {
