...
( function ( window, $, undefined ) {
	...
	$(
		function () {
			 ...
			 * @return {void}
			 */
			var shrinkTextarea = window._.throttle(
				function () {
			 ...
			 */
			$document.on(
				'tinymce-editor-init.editor-expand',
			...
			function on() {
				...
				$window.on(
					'scroll.editor-expand resize.editor-expand',
					function ( event ) {
						adjust( event.type );
						afterScroll();
					}
				...
				$document.on( 'wp-collapse-menu.editor-expand postboxes-columnchange.editor-expand editor-classchange.editor-expand', adjust )
					.on(
						'postbox-toggled.editor-expand postbox-moved.editor-expand',
						function () {
						...
						'wp-window-resized.editor-expand',
						function () {
							if ( mceEditor && ! mceEditor.isHidden() ) {
			...
			function off() {
				...
				// Reset all CSS.
				$.each(
					[ $visualTop, $textTop, $tools, $menuBar, $bottom, $statusBar, $contentWrap, $visualEditor, $textEditor, $sideSortables ],
					function ( i, element ) {
			...
			$( '#editor-expand-toggle' ).on(
				'change.editor-expand',
				function () {
