...
( function ( $, wp ) {
	...
	window.inlineEditPost = {
		...
		init : function () {
			 ...
			 */
			$( '#inline-edit .inline-edit-private input[value="private"]' ).on(
				'click',
				function () {
		...
		setBulk : function () {
			 ...
			 */
			$( 'tbody th.check-column input[type="checkbox"]' ).each(
				function () {
			...
			if ( 'post' === type ) {
				$( 'tr.inline-editor textarea[data-wp-taxonomy]' ).each(
					function ( i, element ) {
						/*
